<%-- 
    Document   : cart
    Created on : Oct 23, 2023, 8:43:01 AM
    Author     : admin
--%>
                    ...
                    <div class="container">
                        ...
                        <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                                ...
                                <li class="nav-item submenu dropdown active">
                                    ...
                                    <ul class="dropdown-menu">
                                        <c:if test="${sessionScope.user.role ==0}">
                                            ...
                                            <li class="nav-item"><a class="nav-link" href="CartControl">Shopping Cart</a></li>
                                            <li class="nav-item"><a class="nav-link" href="confirmation.jsp">Confirmation</a></li>
                                        </c:if>
                                        <c:if test="${sessionScope.user.role ==1}">
                                            <li class="nav-item"><a class="nav-link" href="ManagerControl">Manager Product</a></li>
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                <li class="nav-item"><a href="ShopServlet" class="cart"><span class="ti-bag"></span></a></li>
                                <li class="nav-item">
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <form action="Tên_Servlet" method="GET">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="media">
                                            ...
                                            <div class="d-flex">
                                                <img src="${p.image}" alt="" style="max-width: 100px; max-height: 100px; object-fit: cover;">
                                            </div>
                                    ...
                                    <td>
                                        <div style="cursor: pointer; background-color: #ff6b6b; color: #fff; padding: 5px 10px; border: none; border-radius: 5px; font-weight: bold; text-align: center; display: flex; align-items: center; justify-content: center;" onclick="deleteProduct(${p.productID})">
                                            <span>Xóa</span>
                                        </div>
                                    </td>
