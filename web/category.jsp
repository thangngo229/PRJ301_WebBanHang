<%-- 
    Document   : category
    Created on : Oct 23, 2023, 8:43:39 AM
    Author     : admin
--%>
                ...
                <div class="col-xl-3 col-lg-4 col-md-5">
                        ...
                        <ul class="main-categories">
                            <c:forEach var="c" items="${requestScope.listC}">
                                <li class="main-nav-list">
                                    <a href="CategoryControl?cid=${c.categoryID}">${c.categoryName}</a>
                                </li>
                            </c:forEach>
                        </ul>
                    </div>
                    <div class="sidebar-filter mt-50">
                        ...
                        <div class="common-filter">
                            ...
                            <form action="FilterControl">
                                <ul>
                                    <c:forEach var="c" items="${requestScope.listColor}">
                                        <li class="filter-list"><input class="pixel-radio" type="radio" id="black" name="color" "><label for="black"><span></span></label>
                                            <a style="color: black" href="FilterControl?cid=${c.colorID}">${c.colorName}</a>
                                        </li>
                                    </c:forEach>    
                                </ul>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="single-product">
                                    ...
                                    <div class="product-details">
                                        <h6><a href="detail?pid=${p.productID}">${p.productName}</a></h6>
                                        <div class="price">
                                            <h6>$ ${p.price*1.5}</h6>
                                            <h6 class="l-through">$${(p.price*2)}</h6>
                                        </div>
